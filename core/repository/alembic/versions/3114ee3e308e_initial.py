...
def upgrade():
    ...
    op.create_table('user_actuator',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('actuator_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['actuator_id'], ['actuator.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['channel_id'], ['channel.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
